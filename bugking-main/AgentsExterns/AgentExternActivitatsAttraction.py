...
def get_activities_tour(location):
                ...
                if "subCategory" in activity.keys():
                    ...
                    if subcategory in subcategories:
                        ...
                        if "address" in activity.keys():
                            ...
                            geo_url = "https://geocode.xyz/"+str(activity['lat'])+","+str(activity['lng'])+"?geoit=json"
    ...
    gr = build_message(gmess,
                       ACL['inform'],
                       sender=AgentExternActivitatsAttraction.uri,
                       content=reg_obj,
                       msgcnt=mss_cnt)
    mss_cnt += 1
    return gr
...
@app.route("/")
def isAlive():
    text = 'Hi i\'m AgentExternActivitatsAttraction o/, if you wanna travel go to <a href= /flights?origin_lat=51.5074&origin_long=0.1278&destination_lat=41.397158&destination_long=2.160873&start_date=2021-06-23&end_date=2021-06-28&price_max=500&num=1>here</a>'
    return text
