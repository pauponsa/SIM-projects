...
public class UserChatChooserAdapter extends RecyclerView.Adapter<UserChatChooserAdapter.myViewHolder> {

    Context mContext;
    List<Chat> mData;
    UserChatChooserFragment mFragment;


    public UserChatChooserAdapter(Context mContext, List<Chat> mData, UserChatChooserFragment mFragment) {
    ...
    private void loadChatInfo(myViewHolder holder, int position)
    {
        ...
        call.enqueue(new Callback<Event>() {
            ...
            public void onResponse(Call<Event> call, Response<Event> response) {
                ...
                loadUserInfo(holder, position, idCreator);
