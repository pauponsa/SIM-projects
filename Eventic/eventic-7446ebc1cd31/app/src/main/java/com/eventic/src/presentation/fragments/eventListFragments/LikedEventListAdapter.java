...
public class LikedEventListAdapter extends RecyclerView.Adapter<LikedEventListAdapter.myViewHolder> {
    ...
    public LikedEventListAdapter(Context mContext, List<EventItem> mData, LikedEventListFragment mFragment) {
        this.mContext = mContext;
        this.mData = mData;
        this.likedFragment = mFragment;
    }
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                likedFragment.clickEvent(mData.get(position));
            }
        });
